package test.tree.binary;

import static org.junit.Assert.*;
import main.tree.binary.*;
...
public class BinaryTreeNodeTests {
    ...
    public void testDoubleTree_t1() {
        BinaryTreeNode t1 = new BinaryTreeNode("A");
        t1.right = new BinaryTreeNode("B");
        t1.right.right = new BinaryTreeNode("C");
        BinaryTreeNode sln = new BinaryTreeNode("A");
        sln.left = new BinaryTreeNode("A");
        sln.right = new BinaryTreeNode("B");
        sln.right.left = new BinaryTreeNode("B");
        sln.right.right = new BinaryTreeNode("C");
        sln.right.right.left = new BinaryTreeNode("C");
    ...
    public void testLevels_t1() {
        ...
        t1.right.right = new BinaryTreeNode("C");
        assertEquals(3, t1.levels());
        t1.right.right.left = new BinaryTreeNode("D");
        assertEquals(4, t1.levels());
    }
